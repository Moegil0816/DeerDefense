...
class CBACalibrationHandler:
    ...
    def getCameraIntrinsics(self, resizeWidth: int = ..., resizeHeight: int = ..., topLeftPixelId: Point2f = ..., bottomRightPixelId: Point2f = ..., keepAspectRatio: bool = ...) -> list[list[float]]:
        ...
        1. getCameraIntrinsics(self: depthai.CBACalibrationHandler, resizeWidth: int = -1, resizeHeight: int = -1, topLeftPixelId: depthai.Point2f = <depthai.Point2f object at 0x000001DF2A53D130>, bottomRightPixelId: depthai.Point2f = <depthai.Point2f object at 0x000001DF2A3AA1F0>, keepAspectRatio: bool = True) -> list[list[float]]

        2. getCameraIntrinsics(self: depthai.CBACalibrationHandler, destShape: depthai.Size2f, topLeftPixelId: depthai.Point2f = <depthai.Point2f object at 0x000001DF2A53D9F0>, bottomRightPixelId: depthai.Point2f = <depthai.Point2f object at 0x000001DF2A35D9B0>, keepAspectRatio: bool = True) -> list[list[float]]

        3. getCameraIntrinsics(self: depthai.CBACalibrationHandler, destShape: tuple[int, int], topLeftPixelId: depthai.Point2f = <depthai.Point2f object at 0x000001DF2A53DBB0>, bottomRightPixelId: depthai.Point2f = <depthai.Point2f object at 0x000001DF2A4E4030>, keepAspectRatio: bool = True) -> list[list[float]]
        """
    @overload
...
class CalibrationHandler:
    ...
    def getCameraIntrinsics(self, cameraId: CameraBoardSocket, resizeWidth: int = ..., resizeHeight: int = ..., topLeftPixelId: Point2f = ..., bottomRightPixelId: Point2f = ..., keepAspectRatio: bool = ...) -> list[list[float]]:
        ...
        1. getCameraIntrinsics(self: depthai.CalibrationHandler, cameraId: depthai.CameraBoardSocket, resizeWidth: int = -1, resizeHeight: int = -1, topLeftPixelId: depthai.Point2f = <depthai.Point2f object at 0x000001DF2A4CA8F0>, bottomRightPixelId: depthai.Point2f = <depthai.Point2f object at 0x000001DF2A52C970>, keepAspectRatio: bool = True) -> list[list[float]]
        ...
        2. getCameraIntrinsics(self: depthai.CalibrationHandler, cameraId: depthai.CameraBoardSocket, destShape: depthai.Size2f, topLeftPixelId: depthai.Point2f = <depthai.Point2f object at 0x000001DF2A53CA30>, bottomRightPixelId: depthai.Point2f = <depthai.Point2f object at 0x000001DF2A53C9F0>, keepAspectRatio: bool = True) -> list[list[float]]
        ...
        3. getCameraIntrinsics(self: depthai.CalibrationHandler, cameraId: depthai.CameraBoardSocket, destShape: tuple[int, int], topLeftPixelId: depthai.Point2f = <depthai.Point2f object at 0x000001DF2A4D71B0>, bottomRightPixelId: depthai.Point2f = <depthai.Point2f object at 0x000001DF2A4E41F0>, keepAspectRatio: bool = True) -> list[list[float]]
...
class NNArchive:
    ...
    def __init__(self, archivePath: os.PathLike, compression: NNArchiveEntry.Compression = ...) -> None:
        ...
        2. __init__(self: depthai.NNArchive, archivePath: os.PathLike, options: depthai.NNArchiveOptions = <depthai.NNArchiveOptions object at 0x000001DF2A4D6F70>) -> None
...
class Node:
    ...
    class Input(MessageQueue):
        ...
        def __init__(self, parent: Node, name: str = ..., group: str = ..., blocking: bool = ..., queueSize: int = ..., types: list[Node.DatatypeHierarchy] = ..., waitForMessage: bool = ...) -> None:
            """__init__(self: depthai.Node.Input, parent: depthai.Node, name: str = '', group: str = '', blocking: bool = True, queueSize: int = 3, types: list[depthai.Node.DatatypeHierarchy] = [<depthai.Node.DatatypeHierarchy object at 0x000001DF2A5CC9B0>], waitForMessage: bool = False) -> None"""
    ...
    class Output:
        ...
        def __init__(self, parent: Node, name: str = ..., group: str = ..., possibleDatatypes: list[Node.DatatypeHierarchy] = ...) -> None:
            """__init__(self: depthai.Node.Output, parent: depthai.Node, name: str = '', group: str = '', possibleDatatypes: list[depthai.Node.DatatypeHierarchy] = [<depthai.Node.DatatypeHierarchy object at 0x000001DF2A5CCDF0>]) -> None"""
...
class SpatialKeypoint:
    ...
    def __init__(self) -> None:
        ...
        2. __init__(self: depthai.SpatialKeypoint, imageCoordinates: depthai.Point3f, spatialCoordinates: depthai.Point3f = <depthai.Point3f object at 0x000001DF2A5EB3B0>, confidence: float = -1.0, label: int = 0, labelName: str = '') -> None

        3. __init__(self: depthai.SpatialKeypoint, imageCoordinates: depthai.Point2f, spatialCoordinates: depthai.Point3f = <depthai.Point3f object at 0x000001DF2A5E8230>, confidence: float = 0.0, label: int = 0, labelName: str = '') -> None
